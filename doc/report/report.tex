...
\begin{figure}[h]
	...
	\begin{tikzpicture}[baseline]
        ...
        \begin{axis}[
            ...
            ylabel={Execution time ($\SI{}{\milli\second}$) [blue]},
            ymin=0, ymax=25000,
            ytick distance=5000,
            minor y tick num = 1,
        ]
        ...
        \begin{axis}[
            ...
            grid style={dashed,black!50},
            xmin=1, xmax=12, xtick distance=1, %x tick label style={rotate=90},
            ylabel={Execution time, log-scale ($\SI{}{\milli\second}$) [red]}, ylabel style={rotate=-180},
        ...
        \end{axis}
    \end{tikzpicture}
    \caption{Execution time plotted against number of students. The number of subjects and classes were kept constant, at 2 and 5 respectively.}
\end{figure}
